...
<nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-white sidebar collapse sidebar-custom">
    <div class="sidebar-sticky pt-3 text-center">
        ...
        <ul class="nav flex-column text-left mt-4">
            ...
            <li class="nav-item mb-4">
                <button class="nav-link btn btn-link {{ Str::startsWith($currentRoute, 'cadastros') || $currentRoute == 'lojas.index' || $currentRoute == 'clientes.index' || $currentRoute == 'produtos.index' ? 'active' : '' }}" onclick="toggleSubMenu('cadastros-submenu')">
                    <i data-feather="users"></i>
                    Cadastros
                </button>
                <ul class="nav flex-column ml-3 {{ Str::startsWith($currentRoute, 'cadastros') || $currentRoute == 'lojas.index' || $currentRoute == 'clientes.index' || $currentRoute == 'produtos.index' ? '' : 'd-none' }}" id="cadastros-submenu">
                    <li class="nav-item">
